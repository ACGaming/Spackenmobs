...
import mod.acgaming.spackenmobs.entity.ai.goal.SmavaCreeperSwellGoal;
...
public class SmavaCreeperEntity extends MonsterEntity implements IChargeableMob
{
	...
	public SmavaCreeperEntity(EntityType<? extends SmavaCreeperEntity> type, World worldIn)
	{
		super(type, worldIn);
	}
	...
	protected void registerGoals()
	{
		...
		this.goalSelector.addGoal(2, new SmavaCreeperSwellGoal(this));
	...
	public void tick()
	{
		if (this.isAlive())
		{
			...
			{
				this.playSound(SpackenmobsRegistry.ENTITY_SMAVA_CREEPER_FUSE.get(), 1.0F, 1.0F);
			}
	...
	{
		return SpackenmobsRegistry.ENTITY_SMAVA_CREEPER_HURT.get();
	}

	protected SoundEvent getDeathSound()
	{
		return SpackenmobsRegistry.ENTITY_SMAVA_CREEPER_BLOW.get();
	}
