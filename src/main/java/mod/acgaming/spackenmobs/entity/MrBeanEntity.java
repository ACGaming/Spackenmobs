...
public class MrBeanEntity extends ZombieEntity
{
	public MrBeanEntity(EntityType<? extends MrBeanEntity> type, World worldIn)
	{
		super(type, worldIn);
	}
	...
	{
		return SpackenmobsRegistry.ENTITY_MRBEAN_AMBIENT.get();
	}

	protected SoundEvent getHurtSound(DamageSource damageSourceIn)
	{
		return SpackenmobsRegistry.ENTITY_MRBEAN_HURT.get();
	}
