...
public class EntitySchalker extends EntityGolem implements IMob
{
	...
	@Override
	@Nullable
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable
	...
	public void setAttachmentPos(@Nullable
	BlockPos pos)
	{
		...
		if (!this.isAIDisabled() && this.isEntityAlive())
		{
			...
			for (int i = 0; i < 5; ++i)
			{
				...
				if (blockpos1.getY() > 0 && this.world.isAirBlock(blockpos1) && this.world.isInsideWorldBorder(this) && this.world.getCollisionBoxes(this, new AxisAlignedBB(blockpos1)).isEmpty())
				{
					...
					if (flag)
					{
						net.minecraftforge.event.entity.living.EnderTeleportEvent event = new net.minecraftforge.event.entity.living.EnderTeleportEvent(this, blockpos1.getX(), blockpos1.getY(),
								blockpos1.getZ(), 0);
